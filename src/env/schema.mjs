...
export const clientSchema = z.object({
  ...
  NEXT_PUBLIC_STARGAZE_MARKETPLACE_URL: z.string(),
  NEXT_PUBLIC_STARGAZE_REST_URL: z.string(),
});
...
export const clientEnv = {
  ...
  NEXT_PUBLIC_STARGAZE_MARKETPLACE_URL:
    process.env.NEXT_PUBLIC_STARGAZE_MARKETPLACE_URL,
  NEXT_PUBLIC_STARGAZE_REST_URL: process.env.NEXT_PUBLIC_STARGAZE_REST_URL,
};
